...
from .block import DFL, BNContrastiveHead, ContrastiveHead, Proto, owProto
from .conv import Conv
from .transformer import MLP, DeformableTransformerDecoder, DeformableTransformerDecoderLayer
from .utils import bias_init_with_prob, linear_init

__all__ = "Detect", "Segment", "Pose", "Classify", "OBB", "RTDETRDecoder", "v10Detect", "ProtoSegment"
...
class ProtoSegment(Detect):
    ...
    def __init__(self, nc=80, nm=32, npr=256, ch=()):
        ...
        self.nm = nm  # number of masks
        self.npr = npr  # number of protos
        self.proto = owProto(ch[0], self.npr, self.nm)  # protos
